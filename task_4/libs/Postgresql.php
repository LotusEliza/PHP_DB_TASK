...
class Postgresql extends SQL
{
    ...
    {
        $this->link = pg_connect("host=localhost port=5432 dbname=user3 user=user3 password=12122")or die('connection failed');
    }

    public function f_select(){
        parent::f_select();
        $result = pg_query($this->link,"SELECT name, age, city FROM user3 WHERE name = 'Liza'");
