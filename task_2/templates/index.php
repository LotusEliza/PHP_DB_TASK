...
<body>
    <div>
        ...
        <h3> Number2 = <?php echo $num2; ?></h3>
        <hr>
        <p>addition: <?php echo $result; ?></p>
        <p>subtraction: <?php echo $result1; ?></p>
        <p>multiplication: <?php echo $result2; ?></p>
        <p>division: <?php echo $result3; ?></p>
        <p>squareRoot: <?php echo $result4; ?></p>
